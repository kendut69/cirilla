...
class RethinkpaySwipeCard extends StatefulWidget {
  final void Function(BuildContext, Map<String, String>) checkout;
  final bool loading;

  const RethinkpaySwipeCard({
    Key? key,
  ...
  @override
  State<RethinkpaySwipeCard> createState() => _RethinkpaySwipeCardState();
}

class _RethinkpaySwipeCardState extends State<RethinkpaySwipeCard> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Center(
            child: Image.asset("assets/images/wait_swipe_card.gif", package: "rethinkpay_gateway", width: 300),
          ),
          if (widget.loading)
