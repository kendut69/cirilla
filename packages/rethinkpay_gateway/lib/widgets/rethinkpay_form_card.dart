...
class RethinkpayFormCard extends StatefulWidget {
  final void Function(BuildContext, Map<String, String>) checkout;
  final bool loading;

  const RethinkpayFormCard({
    Key? key,
  ...
  @override
  State<RethinkpayFormCard> createState() => _RethinkpayFormCardState();
}

class _RethinkpayFormCardState extends State<RethinkpayFormCard> {
  String cardNumber = '';
  String expiryDate = '';
  String cvvCode = '';
