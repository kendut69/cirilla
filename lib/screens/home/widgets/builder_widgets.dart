...
class _BuilderWidgetsState extends State<BuilderWidgets> with Widgets, ScrollMixin, AppBarMixin, LoadingMixin, Utility {
    ...
    return Scaffold(
      ...
      body: enableStackLayout && widgetIds.isNotEmpty
          ? buildStack(
              ...
              isAppbar: isAppbar && enableAppbar!
            )
          : buildScroll(
              scroll: controller,
              widgetIds: widgetIds,
  ...
  Widget buildStack({
    ...
    return NotificationListener<DraggableScrollableNotification>(
      ...
      child: Stack(
        children: [
          buildWidget(widgets[id], isAppbar),
          DraggableScrollableActuator(
            child: DraggableScrollableSheet(
              ...
              builder: (
                ...
                return buildScroll(scroll: scrollController, widgetIds: newWidgetIds, isRefresh: false);
              },
            ),
          ),
        ],
      ...
      slivers: <Widget>[
        ...
        if (isRefresh)
          CupertinoSliverRefreshControl(
            onRefresh: () => _settingStore.getSetting(CachePolicy.refresh),
            builder: (
              BuildContext context,
        ...
        buildWidgets(context, widgetIds: widgetIds, widgets: widgets, isAppbar: !isAppbar && enableAppbar!)
      ],
    );
  }
}
