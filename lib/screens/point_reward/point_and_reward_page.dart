...
import '../../store/point_and_reward/point_and_reward_store.dart';
...
class _PointBodyState extends State<PointBody> with AppBarMixin, LoadingMixin {
  ...
  void _onScroll() {
    if (!_controller.hasClients ||
        _pointAndRewardStore.loadingListEvent ||
        !_pointAndRewardStore.canLoadMore) return;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Observer(
        builder: (context) {
          List<PointRewardEvent> pointRewardEvents =
              _pointAndRewardStore.pointRewardEvents;
          bool loading = _pointAndRewardStore.loadingListEvent;

          bool isShimmer = pointRewardEvents.isEmpty && loading;
          List<PointRewardEvent> loadingProduct =
              List.generate(10, (index) => PointRewardEvent()).toList();

          List<PointRewardEvent> data =
              isShimmer ? loadingProduct : pointRewardEvents;
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(translate('current_point_balance'),
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Padding(
                            ...
                            child: PointRewardEventItem(
                                item: data[index], loading: isShimmer),
                          );
                        },
                      ),
                    ],
              ...
              if (loading)
                SliverToBoxAdapter(
                  child: buildLoading(context,
                      isLoading: _pointAndRewardStore.canLoadMore),
                ),
            ],
          );
        },
