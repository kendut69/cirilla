...
CartData _$CartDataFromJson(Map<String, dynamic> json) => CartData(
      ...
      ..extensions = CartData._fromToMap(json['extensions'])
      ..fees = CartData._fromFeesItem(json['fees']);
...
Map<String, dynamic> _$CartDataToJson(CartData instance) => <String, dynamic>{
      ...
      'fees': CartData._toFeesItem(instance.fees),
    };
...
QuantityLimit _$QuantityLimitFromJson(Map<String, dynamic> json) =>
    QuantityLimit(
      ...
      step: (json['multiple_of'] as num?)?.toInt() ?? 1,
    );
...
Map<String, dynamic> _$CartFeesToJson(CartFees instance) => <String, dynamic>{
      'key': instance.key,
      'name': instance.name,
      'totals': instance.totals,
    };
