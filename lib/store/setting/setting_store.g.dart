...
mixin _$SettingStore on SettingStoreBase, Store {
  ...
  bool get enableUsingBiometric => (_$enableUsingBiometricComputed ??=
      ...
      .value;
  Computed<Features>? _$featuresComputed;
  ...
  late final _$_featuresAtom =
      Atom(name: 'SettingStoreBase._features', context: context);

  @override
  Features get _features {
    _$_featuresAtom.reportRead();
    return super._features;
  }

  @override
  set _features(Features value) {
    _$_featuresAtom.reportWrite(value, super._features, () {
      super._features = value;
    });
  }
  ...
  @override
  Future<void> getSetting([CachePolicy? cachePolicy]) {
    return _$getSettingAsyncAction.run(() => super.getSetting(cachePolicy));
  }
