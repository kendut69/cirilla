...
mixin _$FilterStore on FilterStoreBase, Store {
  ...
  ProductPrices get productPrices => (_$productPricesComputed ??=
      ...
      .value;
  Computed<RangeValues>? _$rangePricesSelectedComputed;

  @override
  RangeValues get rangePricesSelected => (_$rangePricesSelectedComputed ??=
          Computed<RangeValues>(() => super.rangePricesSelected,
              name: 'FilterStoreBase.rangePricesSelected'))
      .value;
  Computed<ProductPrices>? _$productPricesSelectedComputed;

  @override
  ProductPrices get productPricesSelected =>
      (_$productPricesSelectedComputed ??= Computed<ProductPrices>(
              () => super.productPricesSelected,
              name: 'FilterStoreBase.productPricesSelected'))
          .value;
  ...
  late final _$_productPricesSelectedAtom =
      Atom(name: 'FilterStoreBase._productPricesSelected', context: context);

  @override
  ProductPrices get _productPricesSelected {
    _$_productPricesSelectedAtom.reportRead();
    return super._productPricesSelected;
  }

  @override
  set _productPricesSelected(ProductPrices value) {
    _$_productPricesSelectedAtom
        .reportWrite(value, super._productPricesSelected, () {
      super._productPricesSelected = value;
    });
  }

  late final _$_rangePricesSelectedAtom =
      Atom(name: 'FilterStoreBase._rangePricesSelected', context: context);

  @override
  RangeValues get _rangePricesSelected {
    _$_rangePricesSelectedAtom.reportRead();
    return super._rangePricesSelected;
  }

  @override
  set _rangePricesSelected(RangeValues value) {
    _$_rangePricesSelectedAtom.reportWrite(value, super._rangePricesSelected,
        () {
      super._rangePricesSelected = value;
    });
  }
  ...
  void onChange(
      ...
      ProductPrices? productPricesSelected,
      RangeValues? rangePricesSelected,
    ...
    try {
      return super.onChange(
          ...
          productPricesSelected: productPricesSelected,
          rangePricesSelected: rangePricesSelected,
