...
class BannerWidget extends StatelessWidget with Utility, NavigationMixin, ContainerMixin {
  ...
  Widget build(BuildContext context) {
    ...
    double? borderRadius = ConvertData.stringToDouble(get(styles, ['radius'], 0));
    ...
    double blurRadius = ConvertData.stringToDouble(get(styles, ['blurRadius'], 0));
    ...
    switch (layout) {
      case Strings.bannerLayoutCarousel:
        return LayoutCarousel(
          length: items!.length,
          buildItem: (_, {required int index, required double width, required double height}) {
